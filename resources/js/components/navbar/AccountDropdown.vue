<template>
  <div v-click-outside="hideAvatarDropdown" class="mt-1 relative md-min:flex md-min:items-center md-min:justify-start w-full rounded-full">
    ...
    <div :class="open ? 'lg:block' : 'lg:hidden'" class="w-full lg:w-350px lg:flex-1 lg:absolute lg:right-0 mt-2 -mb-2 lg:mt-4 lg:py-2 bg-white rounded-none lg:shadow-dropdown block tw-account-dropdown">
