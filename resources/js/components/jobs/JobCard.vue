                  ...
                  <div class="card-body container px-4 lg:px-5">
                    <div class="flex flex-col py-4">
                      <div class="flex items-baseline justify-between">
                        <strong class="font-gotham-book text-sm text-gray-900 font-semibold">Developer to build a custom screensaver for MacOS</strong>
                        <span class="text-link text-gray-900 font-medium">Rated as Client</span>
                      </div>
