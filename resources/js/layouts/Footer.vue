<template>
  <footer class="bg-footer relative flex flex-wrap items-center justify-between text-white w-ful font-light">
    <div class="container mx-auto px-4 lg:px-6 flex flex-wrap items-center justify-between">
      ...
      <!-- Footer Line -->
      <div class="w-full border-b opacity-25" />
          ...
          <ul class="block flex flex-wrap flex-col justify-between w-full m-0 p-0">
            ...
            <li class="list-none py-3">
              ...
              >
                ...
                >
                  <path
                    d="M20.515,0H3.521A3.525,3.525,0,0,0,0,3.521V20.515a3.525,3.525,0,0,0,3.521,3.521H20.515a3.525,3.525,0,0,0,3.521-3.521V3.521A3.525,3.525,0,0,0,20.515,0ZM8.5,19.06H5.68V9.2H8.5Zm0-11.267H5.68V4.976H8.5ZM18.356,19.06H15.539V13.426a1.408,1.408,0,0,0-2.817,0V19.06H9.906V9.2h2.817v.531A6.106,6.106,0,0,1,14.835,9.2a3.687,3.687,0,0,1,3.521,3.741Zm0,0"
                    fill="#fff"
                  />
                </svg>
            ...
            <li class="list-none py-3">
              ...
              >
                ...
                >
                  <path
                    id="facebook"
                    d="M20.613,0H3.538A3.542,3.542,0,0,0,0,3.538V20.613A3.542,3.542,0,0,0,3.538,24.15H10.66V15.613H7.83V11.368h2.83V8.49a4.25,4.25,0,0,1,4.245-4.245H19.2V8.49H14.905v2.877H19.2l-.708,4.245H14.905V24.15h5.707a3.542,3.542,0,0,0,3.538-3.538V3.538A3.542,3.542,0,0,0,20.613,0Zm0,0"
                    fill="#fff"
                  />
                </svg>
      ...
      <!-- Footer Line -->
      <div class="opacity-25 border-b w-full pb-10" />
